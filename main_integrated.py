...
=================================================
통합 실행 파이프라인 (Refactored)

Modular Pipeline Architecture:
1. Collectors: 데이터 수집 (FRED, Market, Crypto)
2. Analyzers: 시장 분석 (Regime, Risk, Liquidity)
...
async def run_integrated_pipeline(
    ...
    result.base_risk_score = cp_res.risk_score # Base score 저장
    ...
    if enable_realtime:
        ...
        save_to_trading_db(signals) # Phase 5 미리 처리
