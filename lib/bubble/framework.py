...
Economic Foundation:
    - JP Morgan Asset Management bubble framework
    - 5 stages: Paradigm Shift → Credit → Leverage → Speculation → Collapse

Class:
    - FiveStageBubbleFramework: Multi-stage bubble analyzer
"""
...
from .enums import JPMorganBubbleStage
from .schemas import StageResult, BubbleFrameworkResult
