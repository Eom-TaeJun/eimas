...
ETF Flow Analyzer
==================
ETF 비중 변화를 통한 시장 상태 분석

CRITICAL_PATH_DESIGN.md 3절 기반 구현:
- Cross-Sectional Flow 분석 (성장/가치, 대형/소형 등)
- 상대 성과 기반 스타일 로테이션 감지
- Risk-On/Risk-Off 판단
- 시장 레짐 추정

경제학적 배경:
- ETF Flow = 투자자들의 집단적 판단
- 비중 변화 = 시가총액 변화 + 자금 유입/유출
- 스타일 로테이션 = 경기 사이클 위치 반영
"""
